...
3b. ✅ **실측 전 필수 보강 3종** — 전사-화자 기반 span grounding·반복발화 힌트·신뢰불가 예측 shape 강등, 적대적 리뷰 4R 수렴, TDD 82 (이번 PR)
3c. ✅ **적대적 리뷰 5R(xhigh) 반영** — 골든 단일 grounding 복원(span은 예측 전용)·힌트 산술 가드(NaN/start_sec/창 거리)·클린 에러 대칭·`_safe` HTML, TDD 107 (이번 PR)
